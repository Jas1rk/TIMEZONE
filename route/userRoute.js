...
router.get(
  "/changepassword",
  middle.isLogged,
  userProfileController.userChangePassword
);
router.post(
  "/changepassword",
  middle.isLogged,
  userProfileController.changePasswordPost
);
router.get("/address", middle.isLogged, userProfileController.addressGet);
router.get(
  "/addressadd",
  middle.isLogged,
  userProfileController.useraddAddress
);
router.post("/addressadd", userProfileController.addAddressPost);
router.get(
  "/addressedit",
  middle.isLogged,
  userProfileController.addressEditGet
);
...
router.get(
  "/useraccountedit",
  middle.isLogged,
  userProfileController.userAccountEdit
);
...
router.get(
  "/checkoutpage",
  middle.isLogged,
  userCartController.userCheckoutPage
);
